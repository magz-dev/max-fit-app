"""
Django settings for max_fitness project.
...
SECRET_KEY = os.environ.get('django-insecure-d25414ap#6rr*&^s#nwjx-7v6_$uta_0^amn@(-ro@q(zm9ic1')
...
WSGI_APPLICATION = 'max_fitness.wsgi.application'
...
if 'USE_AWS' in os.environ:
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'sportstylehub'
